...
- (BOOL)tableView:(UITableView *)tableView canMoveRowAtIndexPath:(NSIndexPath *)index Path
{
...
{
    SQLiteDetialViewController *detailVC = nil;
    detailVC = segue.destinationViewController;
    detailVC.tableName = sender;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    [self performSegueWithIdentifier:@"tableToDetail" sender:[tableList objectAtIndex:indexPath.row]];
...
- (IBAction)didClickCreateTable:(UIBarButtonItem *)sender {
    ...
    [[SQLiteManager defaultManager]createTable:tableName attribute:attribute];
    [tableList addObjectsFromArray:[[SQLiteManager defaultManager]tableListFromDatabase]];
