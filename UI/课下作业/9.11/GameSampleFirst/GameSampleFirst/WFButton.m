...
{
    WFButton *result = nil;
    NSInteger upTag = (self.y - 1) * 1000 + self.x + 1;
...
{
    WFButton *result = nil;
    NSInteger downTag = (self.y + 1) * 1000 + self.x + 1;
...
{
    WFButton *result = nil;
    NSInteger leftTag = (self.y ) * 1000 + self.x - 1 + 1;
...
{
    WFButton *result = nil;
    NSInteger rightTag = (self.y) * 1000 + self.x + 1 + 1;
