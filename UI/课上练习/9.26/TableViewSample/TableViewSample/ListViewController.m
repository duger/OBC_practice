...
- (void)tableView:(UITableView *)tableView performAction:(SEL)action forRowAtIndexPath:(NSIndexPath *)indexPath withSender:(id)sender 
{
    if (action == @selector(cut:)) {
        ...
        NSIndexPath *firstIndexPath = [NSIndexPath indexPathForRow:indexPath.row inSection:0];
        NSIndexPath *secondIndexPath = [NSIndexPath indexPathForRow:indexPath.row inSection:1];
        
        [tableView deleteRowsAtIndexPaths:@[firstIndexPath,secondIndexPath] withRowAnimation:UITableViewRowAnimationMiddle];
    }
}
