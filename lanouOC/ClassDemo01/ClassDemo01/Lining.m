...
+(id)liningWithName:(NSString *)_name board:(NSString *)_board size:(NSInteger)_size madeCountry:(NSString *)_madeCountry useKind:(NSString *)_useKind price:(CGFloat)_price
{
    Lining *shose = [[Lining alloc]initWithName:_name board:_board size:_size madeCountry:_madeCountry useKind:_useKind price:_price];
    return [shose autorelease];
}
+(id)liNingWithSize:(NSString *)_madeCountry
{
    Lining *shoes = [[Lining alloc]initWithName:nil board:nil size:0 madeCountry:_madeCountry useKind:nil price:0];
