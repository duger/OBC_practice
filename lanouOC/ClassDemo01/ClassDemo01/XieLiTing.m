...
{
    XieLiTing *medicine = [[XieLiTing alloc] initWithName:_name andAffect:_affect andISD:_ISD andPrice:_price andPackage:_package andSmell:_smell];
...
{
    XieLiTing *medicine = [[XieLiTing alloc]initWithName:nil andAffect:nil andISD:nil andPrice:_price andPackage:nil andSmell:nil];
    return [medicine autorelease];
}
