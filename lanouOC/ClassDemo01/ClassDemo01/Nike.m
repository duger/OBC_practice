...
{
    Nike *shose = [[Nike alloc]initWithName:_name board:_board size:_size madeCountry:_madeCountry useKind:_useKind price:_price];
    return [shose autorelease];
}

+(id)nikeWithSize:(NSString *)_madeCountry
{
    Nike *shoes = [[Nike alloc]initWithName:nil board:nil size:0 madeCountry:_madeCountry useKind:nil price:0];
